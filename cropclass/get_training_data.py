...
tsclust.plot_clusters(clust4, fill=False)
...
test = random_ts_samples(ndvi_lc, 5000, seed=0)
...
t = get_training_data(fp, bd, allsamples)
...
def format_training_data(training_data, one_hot=True, shuffle=True, seed=None):
    ...
    # Data labels (Y values); first encode labels as intigers
...
x, y = format_training_data(t, shuffle=True, seed=0)
