...
def get_mask_indices(mask):
    '''Gets the indices of non-nan values in crop mask
    :param mask: 3d numpy array corresponding to time series of land cover mask
    :return: np.array of dim: (#non-nan cells, (rowindex, colindex))
    '''
